...
public final class ConvertUtil {
     ...
     * <p>转换不成功时返回defaultValue并记录info或??warn日志，不会抛出任何异常??
     * <p>value等于null或??为空字符串，或??在转换过程中发生异常，均返回defaultValue，否则返回转换后的{@link Integer}值??
     ...
     * <p>转换不成功时返回defaultValue并记录info或??warn日志，不会抛出任何异常??
     * <p>value等于null或??为空字符串，或??在转换过程中发生异常，均返回defaultValue，否则返回转换后的{@link Long}值??
     ...
     * <p>转换不成功时返回defaultValue并记录info或??warn日志，不会抛出任何异常??
     * <p>value等于null或??为空字符串，或??在转换过程中发生异常，均返回defaultValue，否则返回转换后的{@link Float}值??
     ...
     * <p>转换不成功时返回defaultValue并记录info或??warn日志，不会抛出任何异常??
     * <p>value等于null或??为空字符串，或??在转换过程中发生异常，均返回defaultValue，否则返回转换后的{@link Double}值??
     ...
     * <p>转换不成功时返回defaultValue并记录info或??warn日志，不会抛出任何异常??
     * <p>value等于null或??为空字符串，或??在转换过程中发生异常，均返回defaultValue，否则返回转换后的{@link BigDecimal}值??
    ...
    public static BigDecimal toDecimal(Object value, BigDecimal defaultValue) {
        ...
        if (Double.class.equals(clazz))
            ...
            // 如果使用new Decimal(doubleValue)，像89.7会变??9.70000000000000012之类??
