...
<div class="section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-primary">
                    <div class="panel-heading"><h3 class="panel-title">Spring Mybatis 框架</h3></div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-2">
                        ...
                        <form class="form-group" method="post" action="/platform/framework/doMakeFramework">
                            <input type="hidden" name="frameworkType" value="springMybatis">
                            <input type="hidden" name="token" value="${submitToken}">
                            <input type="hidden" name="webFramework" value="springMVC">
