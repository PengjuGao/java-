...
<div class="section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-primary">
                    <div class="panel-heading"><h3 class="panel-title">Struts2 Mybatis 框架</h3></div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <img src="/style/img/new_mybatis1.jpg" alt="java框架生成" class="img-thumbnail" width="100px" height="100px"/>
                            </div>
                            <div class="col-md-2">
                        ...
                        <form class="form-group" method="post" action="/platform/framework/doMakeFramework">
                            <input type="hidden" name="frameworkType" value="structs2Mybatis">
                            <input type="hidden" name="token" value="${submitToken}">
                            <input type="hidden" name="webFramework" value="structs2">
                            <input type="hidden" name="ormFramework" value="mybatis">
