...
<div class="section">
    <div class="container">
        <div class="row">
                    ...
                    <div class="panel-body">
                        <ul class="list-group">
                            <li class="list-group-item">
                                <button type="button" name="ssh" class="btn btn-block btn-primary gl">Struts2 Spring Hibernate</button>
                            </li>
            ...
            <div class="col-md-9">
                <div class="panel panel-primary">
                    <div class="panel-heading"><h3 class="panel-title">Struts2 Hibernate 框架</h3></div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-2">
                        ...
                        <form class="form-group" role="form" method="post" action="/platform/framework/doMakeFramework">
                            <input type="hidden" name="frameworkType" value="structs2Hibernate">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" class="form-control" maxlength="30" placeholder="请输入项目包名" name="packageName" required>
                            </div>
                            <div class="col-md-12"><hr></div>
                            <h4>数据库连接池</h4>
                            ...
                            <div class="col-md-12 hidden"><hr></div>
                            <h4 class="hidden">缓存服务</h4>
