...
<root>
    ...
    <element action="copy" suffix="xml" name="mybatis-config" target="framework/springMybatis/mybatis/mybatis-config.ftl" parentNode="resources_mybatis"/>
    <element action="copy" suffix="xml" name="applicationContext-mybatis" target="framework/springMybatis/mybatis/applicationContext-mybatis.ftl" parentNode="resources_spring"/>
    <!-- 进行修改 -->
    <!--是否是多数据源-->
<#if isMoreOrSingle == 1>
