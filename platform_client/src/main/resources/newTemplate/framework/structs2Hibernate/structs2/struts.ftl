...
<struts>
    ...
    <package name="test" namespace="/test" extends="struts-default" strict-method-invocation="false">
        <action name="database" class="${packageName}.web.TestAction" method="testDatabase">
            <result name="success">
                /WEB-INF/views/testDatabase.html
            </result>
        </action>
        <action name="index" class="${packageName}.web.TestAction" method="index">
        ...
        <#if sitemesh=="yes">
        <!-- test sitemesh-->
        <action name="nositemesh" class="${packageName}.web.TestAction" method="nositemesh">
        <#if template=="freemaker">
            <result name="success" type="freemarker">
