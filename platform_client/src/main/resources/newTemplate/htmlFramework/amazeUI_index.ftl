...
<head>
  ...
  <script src="/static/amazeUI/js/amazeui.ie8polyfill.min.js"></script>
  <![endif]-->
  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        ...
        <li><a href="/test/index"><span class="am-icon-table"></span> 测试spring是否能跳转</a></li>
        <#if cache!="">
        <li><a href="/test/cache"><span class="am-icon-pencil-square-o"></span> 测试注解缓存能否使用</a></li>
        </#if>
        <li><a href="/test/database"><span class="am-icon-pencil-square-o"></span> 测试数据库查询</a></li>
        ...
        <li><a href="/test/nositemesh"><span class="am-icon-pencil-square-o"></span> 不带sitemesh测试</a></li>
      </ul>
    </div>
  </div>
  <!-- sidebar end -->
