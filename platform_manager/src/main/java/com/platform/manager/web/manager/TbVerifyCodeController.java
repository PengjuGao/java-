...
import com.platform.core.vo.condition.TbVerifyCodeConditionVo;
...
@Controller
@RequestMapping("/system/tbverifycode/")
public class TbVerifyCodeController extends BaseController<TbVerifyCode, TbVerifyCodeVo> {
	
	@Autowired
	public TbVerifyCodeService service;
	
	@Override
	protected void queryList(Object vo,TbVerifyCode t, TbVerifyCodeVo e,PageBean pageBean,
			HttpServletRequest request, HttpServletResponse response,
			Model model) {
		
		TbVerifyCodeConditionVo tempVo = (TbVerifyCodeConditionVo)vo;
		...
		TbVerifyCodeVo.Criteria criteria = e.createCriteria();
		...
		List<TbVerifyCode> list = service.selectByVo(e);
		
		model.addAttribute("list", list);
		
		model.addAttribute("vo", tempVo);
		
		Page<TbVerifyCode> page = service.selectByVoAndPage(e, pageBean);
