...
import com.platform.core.vo.condition.TableAndColumnsConditionVo;
...
@Controller
@RequestMapping("/system/tableandcolumns/")
public class TableAndColumnsController extends BaseController<TableAndColumns, TableAndColumnsVo> {
	
	@Autowired
	public TableAndColumnsService service;
	
	@Override
	protected void queryList(Object vo,TableAndColumns t, TableAndColumnsVo e,PageBean pageBean,
			HttpServletRequest request, HttpServletResponse response,
			Model model) {
		
		TableAndColumnsConditionVo tempVo = (TableAndColumnsConditionVo)vo;
		...
		TableAndColumnsVo.Criteria criteria = e.createCriteria();
		...
		List<TableAndColumns> list = service.selectByVo(e);
		
		model.addAttribute("list", list);
		
		model.addAttribute("vo", tempVo);
		
		Page<TableAndColumns> page = service.selectByVoAndPage(e, pageBean);
