 ...
 * @author hu
 */
public class NewsCrawler_author extends BreadthCrawler {
     ...
     */
    public NewsCrawler_author(String crawlPath, boolean autoParse) {
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        if (page.matchUrl("http://www.gushiwen.org/default_\\d*.aspx")) {
            ...
            /*extract title and content of news by css selector*/
                ...
                //写入数据库---处理数据
                String inserSql = "insert into tb_poem values(0,'"+title+"','"+nianDAI+"','"+authorStr+"','"+content+"','"+id+"')";
    ...
    public static void main(String[] args) throws Exception {
        NewsCrawler_author crawler = new NewsCrawler_author("crawl", true);
