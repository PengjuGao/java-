		...
		<tbody>
			...
			<tr>
				...
				<td><select size="1" name="select2">
						...
						<option value="10401">质企中心</option>
						<option value="10402">技术中心</option>
						<option value="10386">CDMA事业部</option>
						<option value="10387">本部事业部</option>
						<option value="10006">技术中心IC所</option>
						<option value="11005">中兴通讯学院</option>
						<option value="11015">第四营销事业部</option>
	...
	<table class="table table-striped table-bordered table-condensed"
		...
		<tbody>
			...
			<tr class="tr_pagenumber">
				<td colspan="100">当前第5页/共55页&nbsp;&nbsp;共650条记录&nbsp;&nbsp;<a
					class="badge badge-inverse">首页</a>&nbsp;<a
					class="badge badge-inverse">下一页</a>&nbsp; <a
					class="badge badge-inverse">1</a>&nbsp;<a
					class="badge badge-inverse">2</a>&nbsp;<a
					class="badge badge-inverse">3</a>&nbsp;<a
					class="badge badge-inverse">4</a>&nbsp; <a
					class="badge badge-warning">5</a>&nbsp;<a
					class="badge badge-inverse">...</a>&nbsp;<a
					class="badge badge-inverse">55</a>&nbsp;<a
					class="badge badge-inverse">上一页</a>&nbsp;<a
					class="badge badge-inverse">尾页</a></td>
			</tr>
		</tbody>
	</table>
</body>
