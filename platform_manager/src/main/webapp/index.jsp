...
<body oncontextmenu="return false">
	<div class="warp">
		...
		<div class="top_c">
			<div class="top-menu">
				<ul class="top-menu-nav">
					...
					<li><a href="#">辅助信息<i class="tip-up"></i></a>
						<ul class="kidc">
							<li><b class="tip"></b><a target="Conframe"
								href="Template/formstyle.html">寻访记录</a></li>
							<li><b class="tip"></b><a target="Conframe"
			...
			<div class="top-nav">
				上午好，欢迎您，邱秋！&nbsp;&nbsp;<a href="#">修改密码</a> | <a href="#">安全退出</a>
			</div>
		</div>
		<!--头部结束-->
		<!--左边菜单开始-->
		<div class="left_c left">
			...
			<div class="acc">
				<div>
					...
					<ul class="kid">
						<li><b class="tip"></b><a target="Conframe"
							href="Template/find-form.html">表单样式</a></li>
						<li><b class="tip"></b><a target="Conframe"
							href="Template/find-alert.html">弹出窗口</a></li>
						<li><b class="tip"></b><a target="Conframe"
							href="Template/find-order.html">查询排序</a></li>
						<li><b class="tip"></b><a target="Conframe"
							href="Template/find-1.html">查询结果一</a></li>
						<li><b class="tip"></b><a target="Conframe"
							href="Template/find-2.html">查询结果二</a></li>
					</ul>
				</div>
				<div>
					<a class="one">维护界面</a>
		...
		<div class="Conframe" style="height: 80%">
